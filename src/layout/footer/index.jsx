...
function Footer() {
  return (
    <footer className="bg-linear-to-l from-gray-950 to-gray-800 mt-12 text-white text-sm/8">
      <div className="container mx-auto py-10 grid grid-cols-1 sm:grid-cols-3">
